...
- <conversations/> ← الاطلاع على جميع محادثاتك مع مختلف العملاء في قاعدة البيانات
...
- عندما تريد اجراء تعامل مع قاعدة البيانات لا داعي لان تطلب من العميل الانتضار في رسالة قبل الرسالة التي ستقوم فيها بالاجراء بل يمكنك فقد القيام بالاجراء مباشرة 
- دائما كن حذرا عند التعامل مع البيانات . و را ترتكب اخطاء مثل حجز غرفة منفصلة لشخصين او ما شابه
- القي نظرة على المحادثات القديمة من قاعدة البيانات بين الحين و الاخر باستخدام رمز جلب المحادثات من قاعدة البياناتات . ربما ستحتاجها بشكل من الاشكال
